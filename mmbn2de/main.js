	...
	const menuTemplate = [
		{
			...
			submenu: [
				...
				},
				{
					...
					enabled: false,
					click () {
						mainWindow.webContents.executeJavaScript("mmbn2de.showScriptSaveSettings()")
					}
				},
				{
					id: 'exit',
			...
			submenu: [
				{
					...
					enabled: false,
					click () {
						mainWindow.webContents.executeJavaScript("mmbn2de.showGotoRowFilters()")
					}
				}
			]
		},
			...
			submenu: [
				{
					...
					enabled: false,
					click () {
						mainWindow.webContents.executeJavaScript("mmbn2de.previewScript()")
					}
				},
				{
					id: 'analyzeScript',
					...
					enabled: false,
					click () {
						mainWindow.webContents.executeJavaScript("mmbn2de.showScriptAnalysisSettings()")
					}
				},
				{
					id: 'configSettings',
					...
					click () {
						mainWindow.webContents.executeJavaScript("mmbn2de.showScriptConfigSettings()")
					}
				}
			]
		},
