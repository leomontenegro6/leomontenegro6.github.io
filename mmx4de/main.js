	...
	const menuTemplate = [
		{
			...
			submenu: [
				...
				},
				{
					...
					enabled: false,
					click () {
						mainWindow.webContents.executeJavaScript("mmx4de.showScriptSaveSettings()")
					}
				},
				{
					id: 'exit',
			...
			submenu: [
				{
					...
					enabled: false,
					click () {
						mainWindow.webContents.executeJavaScript("mmx4de.showGotoRowFilters()")
					}
				}
			]
		},
			...
			submenu: [
				{
					...
					enabled: false,
					click () {
						mainWindow.webContents.executeJavaScript("mmx4de.previewScript()")
					}
				},
				{
					id: 'analyzeScript',
					...
					enabled: false,
					click () {
						mainWindow.webContents.executeJavaScript("mmx4de.showScriptAnalysisSettings()")
					}
				},
				{
					id: 'configSettings',
					...
					click () {
						mainWindow.webContents.executeJavaScript("mmx4de.showScriptConfigSettings()")
					}
				}
			]
		},
